                        ...
                        <div class="field">
                            ...
                            <div class="select is-small">
                                <select @change="setConfig">
                                    ...
                                    <option value="uploaded" :selected="configStore.name === 'uploaded'">Upload custom ...</option>
                                </select>
                            </div>
                            <!-- todo: allow to import custom config file -->
                        </div>
                        <div class="field" v-if="configStore.name === 'uploaded'">
                            <label class="label is-small">Upload config file:</label>
                            <input class="button is-small" style="margin-left: 15px" type="file"
                                name="configfile" @change="(event) => {
                                readFile(event)
                                }"
                                />
                        </div>
...
import testConfig from '../configs/test-config.json';
