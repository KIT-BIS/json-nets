	...
	<div class="card scoped-modal-side has-background-light scoped-modal-right">
		<section class="m-5 scoped-scrollable-outer">
			<div class="scoped-scrollable-container" v-if="transitionsStore.outputArcs.length > 0">
							...
							<div class="field has-addons">
								...
								<p class="control">
									<span class="select is-small">
										<select v-model="transitionsStore.selectedOutputPlaceIndex"
											@change="onOutputPlaceSelect">
											<option v-for="(arc, index) in transitionsStore.outputArcs" :value="index">
												{{ arc.name }}</option>
										</select>
									</span>
								</p>
				...
				transitionsStore.outputArcs[transitionsStore.selectedOutputPlaceIndex].filtered.length
                      ...
                      " />
						...
						<div v-else class="level-item">
							...
							<input @input="onFilterOutput" style="width: 100px" class="input is-small mr-1"
							...
							<button class="mr-1 button is-small " @click="cancelFilterEdit">
								<span class="icon is-small has-text-grey"><font-awesome-icon
										icon="fas fa-xmark" /></span>
							</button>
				...
				<div class="scoped-scrollable jsn-code p-2">
					<vue-json-pretty :key="transitionsStore.outputDataKey"
						:data="transitionsStore.outputArcs[transitionsStore.selectedOutputPlaceIndex].marking"
						@selected-change="onSelectValueClick" :selected-value="selectedOutputValueDotsBracketsPath"
