		...
		<div class="scoped-modal-container">
			...
			<div class="modal-card scoped-modal-center">
				...
				<section class="modal-card-body" v-if="(uiStateStore.uiAssistMode === 'expert')">
					...
					<div v-if="transitionsStore.outputArcs.length > 0" class="block">
						<div class="field">
							...
							<p v-if="transitionsStore.hasAnyOutputError" class="help is-danger">Some output expressions
								have
								errors.</p>
						</div>
					...
					<div class="block">
						<div class="field">
							...
							<div
								...
								<p v-if="transitionsStore.guardHasError" class="help is-danger">Guard expression has
									errors.
								</p>
				...
				<section class="modal-card-body" v-else>
					<TransitionTypeSelector />
					<div class="field"
						v-for="[key, value] in Object.entries(transitionsStore.transition.customVariables)">
...
/**
 * Shows a window with different functions to interact with transition and connected arcs properties.
 */
