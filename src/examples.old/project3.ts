    ...
    "transitions": [
      {
        ...
        "fragmentVarSnippets": {
          "output_plannedProject_value": "local output_plannedProject_value = input_projectInitialization_value + { \"team\": [] };"
        }
      },
      {
        ...
        "name": "start project",
        "preface": "",
        "guard": "std.length(input_plannedProject_value.open_tasks) == 0",
        "keyVarSnippets": {
          "output_runningProject_key": "local output_runningProject_key = '-';"
        },
        "fragmentVarSnippets": {
          "output_runningProject_value": "local output_runningProject_value = {\n  \"pid\": input_plannedProject_value.pid,\n  \"projname\": input_plannedProject_value.projname,\n  \"team\": input_plannedProject_value.team\n};"
        }
      },
      {
        ...
        "keyVarSnippets": {
          ...
          "output_lessonLearned_key": "local output_lessonLearned_key = 'lessons';"
        },
        "fragmentVarSnippets": {
          "output_finishedProject_value": "local output_finishedProject_value = input_runningProject_value;",
          "output_lessonLearned_value": "local output_lessonLearned_value = input_runningProject_value.team;"
        }
      },
      {
        ...
        "preface": "",
        "guard": "output_plannedProject_token == input_plannedProject_token &&\noutput_employee_token.work_in_proj == null",
        "keyVarSnippets": {
          "output_plannedProject_key": "local output_plannedProject_key = 'responsible';",
          "output_employee_key": "local output_employee_key = 'work_in_proj';"
        },
        "fragmentVarSnippets": {
          "output_plannedProject_value": "local output_plannedProject_value = { \"member\": output_employee_token.empid,\n\"task\": input_plannedProject_value};",
      ...
      },
      {
        ...
        "preface": "",
        "guard": "input_employee_value.empid == input_lessonLearned_value.member",
        "keyVarSnippets": {
          "output_employee_key": "local output_employee_key = '-';"
        },
        "fragmentVarSnippets": {
          "output_employee_value": "local output_employee_value = {\n \"empname\": input_employee_value.empname,\n \"empid\": input_employee_value.empid,\n \"work_in_proj\": null,\n \"skills\": input_employee_value.skills + [input_lessonLearned_value.task]\n};"
        }
      }
    ],
    "arcs": [
