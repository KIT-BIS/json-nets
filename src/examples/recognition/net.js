    ...
    },
    {
      ...
      content: {
        schema: {
          ...
          required: ['studentId', 'level', 'studyProgram', 'email']
        },
        data: [
          {
            studentId: 'student-1',
          ...
          properties: {
            ...
            recognizableLectures: {
              ...
              items: {
                ...
                required: ['universityId', 'lecture']
              }
            }
          },
          required: ['name', 'levels', 'studyPrograms', 'recognizableLectures']
        },
        data: [
          {
    ...
    },
    {
      ...
      content: {
        schema: {
          ...
          required: ['studentId', 'lecture', 'grade']
        },
        data: []
      }
    }
