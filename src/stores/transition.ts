...
/**
 * Provides state of currently selected transition to be shown in TransitionModal.
 */
export const useTransitionsStore = defineStore('transitions', {
	...
	actions: {
		...
		unsetAssignments() {
			// Todo: communication should probably always only be with net instance not its members
